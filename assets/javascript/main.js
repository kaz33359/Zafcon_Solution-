   ...
   'use strict'
    ...
    var retinaLogos = function() {
      var retina = window.devicePixelRatio > 1 ? true : false;
        ...
        if(retina) {
            $('.logo').find('img').attr( {src:'assets/images/logo/Zafconsolutionslogo.png',width:'159',height:'70'} );   
        }
    };  
    ...
    var retinaLogos2 = function() {
        var retina = window.devicePixelRatio > 1 ? true : false;
          ...
          if(retina) {
              $('#footer').find('img').attr( {src:'assets/images/logo/Zafconsolutionslogo.png'} );   
          }
    };   
